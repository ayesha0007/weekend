        ...
        <Container>
          <Row>
            ...
            <Col md="3" sm="12" className="location mt-3 mt-md-0 ">
              ...
              <div className="d-flex align-items-center">
                <p className="pb-2"> IUB , BANGLADESH</p>
              </div>

              <div className="d-flex align-items-top my-2">
                <i className="bi bi-geo-alt me-3"></i>
                <a target="_blank" href="mailto:ayeshasiddika1257@gmail.com" className="d-block" >ayeshasiddika1257@gmail.com</a>
              </div>
              <div className="d-flex align-items-top ">
                <i className="bi bi-telephone me-3"></i>
                <a target="_blank" href="tel:01234567890" className="d-block" >0123456789</a>
              </div>
          ...
          <Row className="py-2 bdr mt-3">
            <Col className="col copyright">
              <p className="text-light">   @ 2024. NISA All rights reserved </p>
            </Col>
          </Row>
